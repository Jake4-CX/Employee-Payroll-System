...
public class BucketSortTest {
    ...
    public void testBucketSort() {
        ...
        List<Employees> sortedEmployees = EmployeeSort.bucketSort(employeeList);

        assertEquals(4, sortedEmployees.size());
        assertEquals(1, sortedEmployees.get(0).getId());
        assertEquals(2, sortedEmployees.get(1).getId());
        assertEquals(3, sortedEmployees.get(2).getId());
        assertEquals(4, sortedEmployees.get(3).getId());
